...
**当前版本：** `1.14.32` / versionCode `252`  
**正式包：** `and/apk/Madus-1.14.32.apk`  
...
| **导入** | 输入框**空白**（无示例字）；多行歌名-歌手 / 网易QQ酷狗酷我；默认上限 **2000** 首（硬顶 3000） |
...
- 已发 **1.14.32**：导入 2000 首；退出再进歌单误触开播（指针落定解锁）  
- 正式包：`apk/Madus-1.14.32.apk`  
