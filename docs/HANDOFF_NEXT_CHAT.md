...
| **视频上下滑 / 听歌切歌** | 滑走或切走再回来从 `sessionPositions` 续播。「上一首」始终切上一条（1.17.9），不要再先重头加载当前 |
...
| 版本 | 内容 | 是否上传 |
|------|------|----------|
| **1.17.9** `d9a1ae0` | 上一首不再先重载当前 | **已传** |
| **1.17.8** `ff15473` | 切歌再切回来续播 | **已传** |
...
- 双仓最新：**1.17.9**  
- 包：`apk/Madus-1.17.9.apk`  
- 下载：https://gitee.com/dikoklhf/madus/releases/tag/v1.17.9  
  备用：https://github.com/zyjshb/Madus/releases/tag/v1.17.9  
