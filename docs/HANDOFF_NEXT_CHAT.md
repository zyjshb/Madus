...
| **1.14.40** | 短视频推荐方案：统一事件、内容画像、四层打分、实时软插入、独立重排器、快速跳过冷却、Debug 推荐行 | **已传 GitHub**；Gitee 待 Grok 发布 |
...
- GitHub 最新：**1.14.40**（commit `8933320`）；Gitee 待 Grok 发布
- 包：`apk/Madus-1.14.40.apk`（已生成）
