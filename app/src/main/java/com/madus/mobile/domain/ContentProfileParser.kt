...
object ContentProfileParser {
    ...
    private val KEYWORD_TOPICS = listOf(
        ...
        "rap" to listOf("说唱", "嘻哈"),
        "alt-rock" to listOf("另类摇滚", "alternative rock", "alternative-rock", "alt rock"),
        "dream-pop" to listOf("梦幻流行", "dream pop", "dream-pop", "dreampop"),
        "shoegaze" to listOf("盯鞋", "自赏", "shoegaze", "shoegazing"),
        "trip-hop" to listOf("trip hop", "trip-hop", "triphop", "迷幻说唱"),
        "indie-pop" to listOf("独立流行", "indie pop", "indie-pop"),
        "post-rock" to listOf("后摇", "post rock", "post-rock"),
